...
// WithAutoProcessByTicketBooth creates a synchronous ticket booth that can track
// how many ticket owners have arrived in order to start batch processing.
func WithAutoProcessByTicketBooth() BatcherOption {
	return func(configs *batcherConfigs) {
		configs.ticketBooth = newTicketBooth()
	}
}
